...
}, C = (a) => [d.prefix, a, d.suffix].filter((e) => e && e.length > 0).join("-"), O = (a) => {
...
async function W(a, e) {
  ...
  }, i = e ? e(n) : n, r = q() ? s.body : await s.blob();
...
class J {
  ...
  async cachePut(e, t) {
    ...
    if (!i)
      return !1;
    const { cacheName: r, matchOptions: c } = this._strategy, o = await self.caches.open(r), u = this.hasCallback("cacheDidUpdate"), g = u ? await j(
    ...
    try {
      ...
      if (f instanceof Error)
        throw f.name === "QuotaExceededError" && await B(), f;
    }
...
class G {
  ...
  addToCacheList(e) {
    ...
    for (const s of e) {
      ...
      const { cacheKey: n, url: i } = A(s), r = typeof s != "string" && s.revision ? "reload" : "default";
...
console.info("Service worker build 26/05/2023, 09:02");
const h = async (a) => {
  console.info(a), (await self.clients.matchAll({ includeUncontrolled: !0, type: "window" })).forEach((t) => {
    t.postMessage({
      type: "LOG",
      message: a
    });
  });
}, re = (a) => "setAppBadge" in self.navigator ? self.navigator.setAppBadge(a).then(() => h("Badge displayed")) : (h("Badge API is not available"), Promise.resolve()), ce = async () => {
  if ("pushManager" in self.registration && typeof self.registration.pushManager.subscribe == "function") {
    ...
    try {
      ...
      return await h("Subscribed successfully"), a;
    } catch (a) {
...
self.skipWaiting();
ie();
ne([{"revision":null,"url":"assets/index-62da142c.css"},{"revision":null,"url":"assets/index-d6dd74b7.js"},{"revision":"d7cc3cc88679149d41cd75b71b91d872","url":"index.html"},{"revision":"013de5474500ddbb23aece0dcc0e8f52","url":"registerSW.js"},{"revision":"eeec202140a133160157b38d0870b22b","url":"icon192.png"},{"revision":"0b031c44a66b36fbcea23dac0bcb0b6e","url":"icon512.png"},{"revision":"b8480fab49bd2b641b37c2b14deef198","url":"manifest.webmanifest"}]);
let P = null;
(async () => (h("Service worker is running"), P = await ce()))();
self.addEventListener("message", (a) => {
  var e, t, s;
  if (((e = a.data) == null ? void 0 : e.type) === "SEND_NOTIFICATION") {
    const n = [];
    n.push(oe()), "setAppBadge" in self.navigator && n.push(self.navigator.setAppBadge(1)), a.waitUntil(Promise.all(n));
  }
  ((t = a.data) == null ? void 0 : t.type) === "REQUEST_PUSH" && (P ? a.waitUntil(le(P)) : a.waitUntil(h("Unable to request a push: no subscription"))), ((s = a.data) == null ? void 0 : s.type) === "APP_OPEN" && "clearAppBadge" in self.navigator && a.waitUntil(self.navigator.clearAppBadge());
});
